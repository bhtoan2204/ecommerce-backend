// copy from https://github.com/signalfx/splunk-otel-go/blob/main/instrumentation/github.com/confluentinc/confluent-kafka-go/v2/kafka/splunkkafka/carrier.go
package kafka
